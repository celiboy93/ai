...
// Model နာမည် (မိတ်ဆွေစာရင်းထဲက အကောင်းဆုံးတစ်ခု)
...
serve(async (req) => {
  ...
  if (req.method === "POST" && url.pathname === "/chat") {
    try {
      ...
      // gemini-2.0-flash ကို အသုံးပြုထားပါသည်
  ...
  return new Response(`
    ...
    <body class="flex flex-col h-screen">
      ...
      <div id="chatBox" class="chat-container flex flex-col">
        <div class="msg ai">မင်္ဂလာပါခင်ဗျာ။ 2D အတွက် အိပ်မက်မေးမလား၊ စကားပြောမလား ရပါတယ်ဗျ။</div>
      </div>
